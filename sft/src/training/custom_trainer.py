...
from transformers.trainer import logger, TrainerState, ExportableState, is_sagemaker_mp_enabled
...
def skip_first_batches(dataloader: DataLoader, num_batches: int) -> Iterator:
    """Skip the first n batches of a dataloader"""
...
class CustomTrainer(Trainer):
    def _inner_training_loop(
        ...
        print("LOCALIZE: _inner_training_loop() in CustomTrainer")
        ...
        if resume_from_checkpoint is not None:
            if is_sagemaker_mp_enabled() or self.is_fsdp_enabled:
        ...
        #trial è None poichè non stiamo utilizzando la ricerca degli iperparametri (I suppose)
