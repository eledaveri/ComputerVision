...
#export CUDA_VISIBLE_DEVICES=0,2   #DA rimuover sela gpu 1 torna libera! RIMUOVERE
MODEL_NAME="HuggingFaceTB/SmolVLM-500M-Instruct"  # Changed from SmolVLM-500M-Instruct
